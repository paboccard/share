...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_569d3b065f5f86_39202363',
  'has_nocache_code' => true,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_569d3b065f5f86_39202363')) {function content_569d3b065f5f86_39202363($_smarty_tpl) {?>
	<!-- Block CMS module -->
			<section id="informations_block_left_1" class="block informations_block_left">
			<p class="title_block">
				<a href="http://localhost/prestashop/index.php?id_cms_category=1&amp;controller=cms">
					Informations				</a>
			</p>
			<div class="block_content list-block">
				<ul>
																							<li>
								<a href="http://localhost/prestashop/index.php?id_cms=1&amp;controller=cms" title="Livraison">
									Livraison
								</a>
							</li>
																								<li>
								<a href="http://localhost/prestashop/index.php?id_cms=2&amp;controller=cms" title="Mentions légales">
									Mentions légales
								</a>
							</li>
																								<li>
								...
								<a href="http://localhost/prestashop/index.php?id_cms=4&amp;controller=cms" title="A propos">
									A propos
																								...
																								<li>
								<a href="http://localhost/prestashop/index.php?id_cms=5&amp;controller=cms" title="Paiement sécurisé">
									Paiement sécurisé
								</a>
							</li>
																						<li>
