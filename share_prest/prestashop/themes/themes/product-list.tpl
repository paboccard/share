...
{if isset($products) && $products}
    ...
    {if $page_name !='index' && $page_name !='product' && $page_name != 'supplier'}
    ...
    <ul{if isset($id) && $id} id="{$id}"{/if} class="product_list grid row{if isset($class) && $class} {$class}{/if}">
        {foreach from=$products item=product name=products}
            ...
            <li class="ajax_block_product{if $page_name == 'index' || $page_name == 'product' || $page_name == 'supplier' } col-xs-12 col-sm-12 col-md-6{else} col-xs-12 col-sm-12 col-md-4{/if}{if $smarty.foreach.products.iteration%$nbItemsPerLine == 0} last-in-line{elseif $smarty.foreach.products.iteration%$nbItemsPerLine == 1} first-in-line{/if}{if $smarty.foreach.products.iteration > ($smarty.foreach.products.total - $totModulo)} last-line{/if}{if $smarty.foreach.products.iteration%$nbItemsPerLineTablet == 0} last-item-of-tablet-line{elseif $smarty.foreach.products.iteration%$nbItemsPerLineTablet == 1} first-item-of-tablet-line{/if}{if $smarty.foreach.products.iteration%$nbItemsPerLineMobile == 0} last-item-of-mobile-line{elseif $smarty.foreach.products.iteration%$nbItemsPerLineMobile == 1} first-item-of-mobile-line{/if}{if $smarty.foreach.products.iteration > ($smarty.foreach.products.total - $totModuloMobile)} last-mobile-line{/if}">
			...
			<div style="float:right">
                ...
                <div class="product-container" itemscope itemtype="https://schema.org/Product">
                    <div class="twitter col-lg-12 theProduct">
                        <header>
                            <div class="header-cont"
                                 style="background: url('{$img_sup_dir}{$product.id_supplier|escape:'html':'UTF-8'}-small_default.jpg') no-repeat, #6bcbca;">
                                {if $product.price_without_reduction > 0 && isset($product.specific_prices) && $product.specific_prices && isset($product.specific_prices.reduction) && $product.specific_prices.reduction > 0}
                                    <div class="border">
                                        <div class="pictures">-{$product.specific_prices.reduction * 100}%</div>
                                    </div>
                                    <div class="name">
                                        <span class="name-head col-lg-9">{$product.name|truncate:45:'...'|escape:'html':'UTF-8'}</span>
                                        <!--<span class="twitter-name col-lg-12">@ericsonluciano</span>-->
                                    </div>
                                {else}
                                    <div class="name">
                                        <span class="name-head col-lg-12">{$product.name|truncate:45:'...'|escape:'html':'UTF-8'}</span>
                                        <!--<span class="twitter-name col-lg-12">@ericsonluciano</span>-->
                                    </div>
                                {/if}
                            </div>
                        ...
                        <section>
                            <div class="details col-lg-12 col-sm-12 col-xs-12">
                                <div class="divider"></div>
                                <div class="following col-lg-6 col-sm-6 col-xs-6">
                                    <span class="detailhead">{$product.gain|string_format:"%.2f"} %</span>
                                    <span class="detailinfo">Don</span>
                                </div>
                                <div class="divider"></div>
                                <div class="followers col-lg-6 col-sm-6 col-xs-6">
                                    <span class="detailhead">{math|string_format:"%.2f" equation="(( x * y ) / 100 )" x=$product.price y=$product.gain}
                                        €</span>
                                    <span class="detailinfo">Argent donné</span>
                                </div>
                            </div>
                        ...
                        <footer>
                            <div class="product-image-container">
						  <span class="detailhead price_product">
			                	{if $product.price_without_reduction > 0 && isset($product.specific_prices) && $product.specific_prices && isset($product.specific_prices.reduction) && $product.specific_prices.reduction > 0}
                                ...
                                {if 0 && isset($product.new) && $product.new == 1}
					...
					<div class="infoArt infoBorder">
						<div class="infoArtTitle col-sm-7">
