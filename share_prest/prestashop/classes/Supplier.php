...
class SupplierCore extends ObjectModel
{
    ...
    public static function getSupplierCategoriesById($id) {
        $a_categories = Category::getCategoriesBySupplier($id);
        return $a_categories;
    }
    ...
    */
    ...
    public function getProductsByCategory($id_category, $id_lang, $p, $n,
        $order_by = null, $order_way = null, $get_total = false, $active = true, $active_category = true) {
        return SupplierCore::getProductsBySupplierAndCategory($this->id,$id_category, $id_lang, $p, $n,
        $order_by, $order_way , $get_total , $active, $active_category);
    }
}
